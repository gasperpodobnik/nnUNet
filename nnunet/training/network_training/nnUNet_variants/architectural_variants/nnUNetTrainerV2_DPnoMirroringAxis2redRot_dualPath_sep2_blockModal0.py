...
class nnUNetTrainerV2_DPnoMirroringAxis2redRot_dualPath_sep2_blockModal0(nnUNetTrainerV2_DPnoMirroringAxis2redRot_dualPath_sep2):
    def run_iteration(
        ...
        data[:,0] *= 0
        # print('Multiplied CT image with 0')
