...
from nnunet.network_architecture.generic_UNet_DP_Dou import Generic_UNet_DP_Dou
...
class nnUNetTrainerV2_DP_DouKD(nnUNetTrainerV2_DPnoMirroringAxis2redRot):
    def initialize_network(self):
        ...
        self.network = Generic_UNet_DP_Dou(
