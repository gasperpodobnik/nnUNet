...
class nnUNetTrainerV2_DPnoMirroringAxis2redRot_dualPath_sep2MR(nnUNetTrainerV2_DPnoMirroringAxis2redRot_dualPath_sep2):
    def run_iteration(
        ...
        #         sitk.WriteImage(sitk_img, os.path.join('/media/medical/projects/head_and_neck/nnUnet/Task208_ONKOI-bothM-curatedFinal-MR-denoise/training_examples' +  f'{rnd_run_id}_{b}_{m}.nii.gz'))
