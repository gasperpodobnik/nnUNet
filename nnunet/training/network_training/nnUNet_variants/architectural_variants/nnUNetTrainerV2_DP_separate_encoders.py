...
from nnunet.network_architecture.generic_UNet_DP_separate_encoders import Generic_UNet_DP_separate_encoders
...
class nnUNetTrainerV2_DP_separate_encoders(nnUNetTrainerV2_DPnoMirroringAxis2redRot):
    def initialize_network(self):
        ...
        self.network = Generic_UNet_DP_separate_encoders(
