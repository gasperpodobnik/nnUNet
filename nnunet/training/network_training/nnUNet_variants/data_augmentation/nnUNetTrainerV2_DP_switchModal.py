...
class nnUNetTrainerV2_DP_switchModal(nnUNetTrainerV2_DPnoMirroringAxis2redRot):
    def run_iteration(
        ...
        # b = 0
        # sitk_img = sitk.GetImageFromArray(data[0, b].cpu().numpy())
        # sitk_img.SetSpacing(data_dict['properties'][b]['spacing_after_resampling'][::-1].tolist())
        # sitk.WriteImage(sitk_img, os.path.join('/media/medical/projects/head_and_neck/nnUnet/' +  f'{b}.nii.gz'))
