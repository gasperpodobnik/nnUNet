...
import torch
from nnunet.network_architecture.generic_UNet_dual_path_sep_instnorm2 import Generic_UNet_dual_path_sep_instnorm2
...
class Generic_UNet_DP_dual_path_sep_instnorm2(Generic_UNet_dual_path_sep_instnorm2):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 max_num_features=None, num_independent_blocks=0):
        """
        As opposed to the Generic_UNet_dual_path, this class will compute parts of the loss function in the forward pass. This is
        ...
        """
        super(Generic_UNet_DP_dual_path_sep_instnorm2, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
                                              ...
                                              max_num_features, num_independent_blocks=num_independent_blocks)
        self.ce_loss = RobustCrossEntropyLoss()

    def forward(self, x, y=None, return_hard_tp_fp_fn=False):
        res = super(Generic_UNet_DP_dual_path_sep_instnorm2, self).forward(x)  # regular Generic_UNet_dual_path forward pass
