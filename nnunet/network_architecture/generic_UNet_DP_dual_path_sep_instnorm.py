...
import torch
from nnunet.network_architecture.generic_UNet_dual_path_sep_instnorm import Generic_UNet_dual_path_sep_instnorm
...
class Generic_UNet_DP_dual_path_sep_instnorm(Generic_UNet_dual_path_sep_instnorm):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_DP_dual_path_sep_instnorm, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
    ...
    def forward(self, x, y=None, return_hard_tp_fp_fn=False):
        res = super(Generic_UNet_DP_dual_path_sep_instnorm, self).forward(x)  # regular Generic_UNet_dual_path forward pass
