...
class Generic_UNet_separate_encoders_prod_fusion(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_separate_encoders_prod_fusion, self).__init__()
