...
import torch
from nnunet.network_architecture.generic_UNet_separate_encoders_sum_fusion import Generic_UNet_separate_encoders_sum_fusion
...
class Generic_UNet_DP_separate_encoders_sum_fusion(Generic_UNet_separate_encoders_sum_fusion):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_DP_separate_encoders_sum_fusion, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
    ...
    def forward(self, x, y=None, return_hard_tp_fp_fn=False):
        res = super(Generic_UNet_DP_separate_encoders_sum_fusion, self).forward(x)  # regular Generic_UNet forward pass
