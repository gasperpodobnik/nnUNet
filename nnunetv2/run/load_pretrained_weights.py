...
def load_pretrained_weights(network, fname, verbose=False, strict=True):
    """
    ...
    # NOTE: I changed this so that it loads all weights, including the segmentation layers
    ...
    if verbose:
        ...
        print("################### Done ###################")
    mod.load_state_dict(model_dict, strict=strict)
